...
/**
 * The Dashboard KPI block: full colour field, label row, big numeral, delta row.
 * bg/fg come from the README's KPI table (blue / red / green / ink).
 */
  ...
  return (
    <div className="flex flex-col gap-3 p-[18px]" style={{ background: bg, color: fg }}>
      <div className="flex items-start justify-between gap-2">
        ...
        <span style={{ opacity: 0.8 }} aria-hidden>{icon}</span>
      </div>
